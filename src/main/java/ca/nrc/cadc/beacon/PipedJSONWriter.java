...
public class PipedJSONWriter extends AbstractPipedWriter
{
    @Override
    ...
    {
        return new JSONStorageItemProducer(pageSize, folderURI, startURI,
                                           new StorageItemJSONWriter(writer),
