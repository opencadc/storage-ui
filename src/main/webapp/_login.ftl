<#if username??>
<a title="User actions." class="dropdown-toggle access-actions user-actions"
   role="button" aria-haspopup="true" aria-expanded="false"
   data-toggle="dropdown">
${username} <span class="caret"></span></a>
<ul class="dropdown-menu list-unstyled">
  <li class="disabled" disabled="disabled">
    <a title="Update profile." href="#" class="disabled" disabled="disabled">My
      profile</a></li>
  <li class="disabled" disabled="disabled">
    <a title="Change password." href="#" class="disabled" disabled="disabled">Change
      password</a></li>
  <li>
    <a id="logout" title="Logout."><span
        class="glyphicon glyphicon-log-out"></span> Logout</a></li>
</ul>
<#else>
<a title="Login form" class="dropdown-toggle access-actions login-form"
   role="button" aria-haspopup="true" aria-expanded="false"
    ...
    <form class="form-inline" id="loginForm" role="form" method="post"
      ...
      <div class="form-group">
        ...
        <input type="text" id="username" name="username" class="form-control"
               tabindex="1" required="required" placeholder="Username"/>
      </div>
      <div class="form-group">
      ...
      <input type="hidden" id="redirectPath" name="redirectPath"
             value="${folder.path}"/>
      <button type="submit" id="submitLogin" class="btn btn-success"><span
